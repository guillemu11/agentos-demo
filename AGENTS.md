...
| AI | Anthropic SDK (`Codex-sonnet-4-6`), Google Gemini (embeddings + voz), Pinecone (vectores) |
...
Reglas detalladas por dominio en `.Codex/rules/`:
- `ai-integrations.md` — Codex, Gemini, Pinecone, RAG pipeline
...
- Despues de CUALQUIER correccion: actualizar `.Codex/tasks/lessons.md` con el patron
...
1. **Plan First**: escribir plan en `.Codex/tasks/todo.md` con items checkeables
...
6. **Capture Lessons**: actualizar `.Codex/tasks/lessons.md` despues de correcciones
...
Target: founders y equipos pequenos usando Codex/LLMs como agentes autonomos.
