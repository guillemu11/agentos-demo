...
// ═══════════════════════════════════════════════════════════════════════════════
// Spy Network — Competitor Persona Accounts
// ═══════════════════════════════════════════════════════════════════════════════
export const spyNetworkData = [
  {
    id: 'spy-001',
    name: 'Sarah Ahmed',
    initials: 'SA',
    ...
    competitor: 'qatar',
    competitorName: 'Qatar Airways',
    market: 'Dubai, AE',
    language: 'en',
    program: 'Privilege Club',
    email: 'sarah.ahmed.spy@proton.me',
    engagementType: 'loyalty',
    status: 'active',
    tier: 'Gold',
    tierColor: '#f59e0b',
    createdAt: '2026-01-15',
    tags: ['Loyalty Program', 'Active Buyer'],
    stats: {
      emailsReceived: 142,
      purchases: 3,
      lastActivity: '2026-04-12',
      avgEmailsPerWeek: 4.2,
      daysActive: 89,
      loyaltyPoints: 45200,
    },
    emailBreakdown: { promo: 48, loyalty: 35, transactional: 22, newsletter: 18, retargeting: 12, other: 7 },
    recentActivity: 'Received tier upgrade notification to Gold',
    timeline: [
      { id: 'tl-sa-1', date: '2026-04-10', type: 'tier-change', title: 'Tier Upgrade to Gold', description: 'Automatically upgraded to Gold after reaching 40,000 Qmiles threshold. Welcome email with lounge access details received within 2 hours.' },
      { id: 'tl-sa-2', date: '2026-03-22', type: 'purchase', title: 'Purchase: DXB → CDG', description: 'Round-trip booking DXB–CDG, Economy class. Confirmation email included dynamic upsell for seat upgrade and lounge pass.' },
      { id: 'tl-sa-3', date: '2026-03-01', type: 'email-cluster', title: 'Pre-Ramadan Email Cluster', description: 'Received 6 emails in 4 days promoting Ramadan travel deals. Mix of promo and loyalty emails. High frequency but good segmentation by destination.' },
      { id: 'tl-sa-4', date: '2026-02-14', type: 'cart-abandon', title: 'Cart Abandon: DXB → SIN', description: 'Abandoned booking for DXB–SIN after fare comparison. Retargeting email sent within 45 minutes with 10% discount code.' },
      { id: 'tl-sa-5', date: '2026-01-15', type: 'signup', title: 'Account Created', description: 'Signed up for Privilege Club via mobile app. Welcome series: 3 emails over 7 days covering benefits, app features, and first-booking incentive.' },
    ],
    emails: [
      { id: 'em-sa-1', subject: 'Spring Sale: Up to 25% Off Select Routes', date: '2026-04-08', category: 'promo', opened: true, clicked: true, hasHtml: true },
      { id: 'em-sa-2', subject: 'Your Avios Balance Update — 45,200 Points', date: '2026-04-05', category: 'loyalty', opened: true, clicked: false, hasHtml: true },
      { id: 'em-sa-3', subject: 'Booking Confirmed: DXB → CDG', date: '2026-03-22', category: 'transactional', opened: true, clicked: true, hasHtml: true },
      { id: 'em-sa-4', subject: 'Still Thinking About Singapore?', date: '2026-02-15', category: 'retargeting', opened: true, clicked: true, hasHtml: true },
    ],
    notes: [
      { id: 'nt-sa-1', text: 'Retargeting email arrived within 45 min of cart abandon — fastest competitor response observed. Discount code was unique and single-use.', date: '2026-02-15', pinned: true, tags: ['retargeting', 'speed'] },
      { id: 'nt-sa-2', text: 'Pre-Ramadan cluster was aggressive (6 emails in 4 days) but well-segmented. Each email targeted different route. No duplicate content.', date: '2026-03-02', pinned: false, tags: ['ramadan', 'frequency'] },
      { id: 'nt-sa-3', text: 'Welcome flow is 3 emails over 7 days. Clean design, mobile-optimized. App download CTA in every email.', date: '2026-01-22', pinned: false, tags: ['welcome', 'onboarding'] },
    ],
  },
  {
    id: 'spy-002',
    name: 'James Miller',
    initials: 'JM',
    avatarGradient: ['#ef4444', '#f97316'],
    competitor: 'etihad',
    competitorName: 'Etihad Airways',
    market: 'London, UK',
    language: 'en',
    program: 'Etihad Guest',
    email: 'james.miller.spy@proton.me',
    engagementType: 'cart-abandon',
    status: 'active',
    tier: null,
    tierColor: null,
    createdAt: '2025-12-15',
    tags: ['Abandoned x4', 'Retargeted'],
    stats: {
      emailsReceived: 67,
      purchases: 0,
      lastActivity: '2026-04-11',
      avgEmailsPerWeek: 3.9,
      daysActive: 120,
      loyaltyPoints: 0,
    },
    emailBreakdown: { promo: 18, loyalty: 5, transactional: 2, newsletter: 10, retargeting: 28, other: 4 },
    recentActivity: 'Cart abandon retargeting for LHR → AUH',
    timeline: [
      { id: 'tl-jm-1', date: '2026-04-11', type: 'cart-abandon', title: 'Cart Abandon: LHR → AUH', description: 'Abandoned Business class booking LHR–AUH. Retargeting email sent within 1 hour with fare-lock offer. Follow-up after 24 hours with alternative dates.' },
      { id: 'tl-jm-2', date: '2026-03-18', type: 'cart-abandon', title: 'Cart Abandon: LHR → BKK', description: 'Abandoned Economy booking LHR–BKK. Retargeting sequence: 3 emails over 5 days. Last email included 15% discount code.' },
      { id: 'tl-jm-3', date: '2026-02-22', type: 'cart-abandon', title: 'Cart Abandon: LHR → DXB', description: 'Abandoned LHR–DXB booking at payment step. Single retargeting email after 2 hours. No discount offered — fare comparison CTA only.' },
      { id: 'tl-jm-4', date: '2026-01-28', type: 'cart-abandon', title: 'Cart Abandon: LHR → MLE', description: 'Abandoned LHR–MLE round-trip. Retargeting email featured destination imagery and "seats filling fast" urgency messaging.' },
      { id: 'tl-jm-5', date: '2025-12-15', type: 'signup', title: 'Account Created', description: 'Signed up for Etihad Guest via website. Welcome email received within minutes. No welcome series — single email only.' },
    ],
    emails: [
      { id: 'em-jm-1', subject: 'Your Abu Dhabi Trip is Waiting — Complete Your Booking', date: '2026-04-11', category: 'retargeting', opened: true, clicked: false, hasHtml: true },
      { id: 'em-jm-2', subject: 'Don\'t Miss Out: Bangkok Fares from £489', date: '2026-03-19', category: 'retargeting', opened: true, clicked: true, hasHtml: true },
      { id: 'em-jm-3', subject: 'Complete Your Dubai Booking — Fares Compared', date: '2026-02-22', category: 'retargeting', opened: false, clicked: false, hasHtml: true },
      { id: 'em-jm-4', subject: 'Maldives Is Calling — Seats Filling Fast', date: '2026-01-29', category: 'retargeting', opened: true, clicked: true, hasHtml: true },
    ],
    notes: [
      { id: 'nt-jm-1', text: 'Etihad retargeting varies heavily by route. Business class abandons get fare-lock offers, Economy gets discounts. Clever segmentation.', date: '2026-04-12', pinned: true, tags: ['retargeting', 'segmentation'] },
      { id: 'nt-jm-2', text: 'No welcome series — just a single email. Missed opportunity compared to Qatar and SIA who both have multi-touch onboarding.', date: '2025-12-20', pinned: false, tags: ['welcome', 'gap'] },
    ],
  },
  {
    id: 'spy-003',
    name: 'Yuki Kobayashi',
    initials: 'YK',
    avatarGradient: ['#22c55e', '#10b981'],
    competitor: 'singapore',
    competitorName: 'Singapore Airlines',
    market: 'Tokyo, JP',
    language: 'ja',
    program: 'KrisFlyer',
    email: 'yuki.kobayashi.spy@proton.me',
    engagementType: 'newsletter',
    status: 'active',
    tier: null,
    tierColor: null,
    createdAt: '2025-09-28',
    tags: ['APAC Market', 'Japanese Comms'],
    stats: {
      emailsReceived: 89,
      purchases: 1,
      lastActivity: '2026-04-09',
      avgEmailsPerWeek: 3.1,
      daysActive: 200,
      loyaltyPoints: 8400,
    },
    emailBreakdown: { promo: 22, loyalty: 8, transactional: 5, newsletter: 42, retargeting: 6, other: 6 },
    recentActivity: 'Opened KrisFlyer monthly newsletter',
    timeline: [
      { id: 'tl-yk-1', date: '2026-04-09', type: 'email', title: 'KrisFlyer Monthly Newsletter', description: 'April newsletter featuring cherry blossom season routes, NRT–SIN special fares, and partner hotel deals. Japanese language, excellent localization.' },
      { id: 'tl-yk-2', date: '2026-03-15', type: 'email', title: 'Year-in-Review Personalized Recap', description: 'Personalized email showing flight history, miles earned, and CO2 offset stats. High-quality data visualization embedded in email.' },
      { id: 'tl-yk-3', date: '2026-02-10', type: 'purchase', title: 'Purchase: NRT → SIN', description: 'Round-trip Premium Economy NRT–SIN. Booking confirmation included personalized meal pre-order and seat selection CTAs.' },
      { id: 'tl-yk-4', date: '2025-12-01', type: 'email', title: 'Holiday Season Promo', description: 'End-of-year promotion with partner discounts. Well-designed email with animated GIF hero banner.' },
      { id: 'tl-yk-5', date: '2025-09-28', type: 'signup', title: 'Newsletter Signup', description: 'Subscribed to KrisFlyer newsletter via SIA website. Immediate confirmation email with preference center link.' },
    ],
    emails: [
      { id: 'em-yk-1', subject: 'KrisFlyer 4月ニュースレター — 桜の季節の特別運賃', date: '2026-04-09', category: 'newsletter', opened: true, clicked: true, hasHtml: true },
      { id: 'em-yk-2', subject: 'Your 2025 Year in Review with Singapore Airlines', date: '2026-03-15', category: 'newsletter', opened: true, clicked: true, hasHtml: true },
      { id: 'em-yk-3', subject: 'Holiday Deals: Fly to 50+ Destinations from ¥49,800', date: '2025-12-01', category: 'promo', opened: true, clicked: false, hasHtml: true },
    ],
    notes: [
      { id: 'nt-yk-1', text: 'SIA Japanese localization is excellent — not just translated, fully adapted. Cultural references (cherry blossom, New Year) are on point. Best-in-class for APAC.', date: '2026-04-10', pinned: true, tags: ['localization', 'best-practice'] },
      { id: 'nt-yk-2', text: 'Year-in-review email had embedded data viz (miles, flights, CO2). Very high engagement — unique approach not seen from other competitors.', date: '2026-03-16', pinned: false, tags: ['personalization', 'innovation'] },
    ],
  },
  {
    id: 'spy-004',
    ...
    initials: 'MR',
    avatarGradient: ['#f59e0b', '#eab308'],
    competitor: 'turkish',
    competitorName: 'Turkish Airlines',
    market: 'Madrid, ES',
    language: 'es',
    program: 'Miles&Smiles',
    email: 'maria.rodriguez.spy@proton.me',
    engagementType: 'multi-market',
    status: 'active',
    tier: 'Silver',
    tierColor: '#94a3b8',
    createdAt: '2025-06-20',
    tags: ['ES + TR Markets', 'Miles&Smiles'],
    stats: {
      emailsReceived: 203,
      purchases: 7,
      lastActivity: '2026-04-13',
      avgEmailsPerWeek: 4.8,
      daysActive: 300,
      loyaltyPoints: 67800,
    },
    emailBreakdown: { promo: 62, loyalty: 45, transactional: 38, newsletter: 30, retargeting: 18, other: 10 },
    recentActivity: 'Received dual-language promo for IST routes',
    timeline: [
      { id: 'tl-mr-1', date: '2026-04-13', type: 'email', title: 'Dual-Language Route Promo', description: 'Promotional email for MAD–IST in Spanish with Turkish cultural content. Interesting hybrid approach — Spanish copy with Turkish destination imagery.' },
      { id: 'tl-mr-2', date: '2026-03-30', type: 'purchase', title: 'Purchase: MAD → IST → TBS', description: 'Multi-city booking Madrid–Istanbul–Tbilisi. Turkish Airlines sent itinerary in Spanish with Istanbul stopover guide in Turkish.' },
      { id: 'tl-mr-3', date: '2026-03-01', type: 'tier-change', title: 'Tier Upgrade to Silver', description: 'Reached Miles&Smiles Silver tier after 5th purchase. Upgrade email sent in Spanish. Benefits summary included Istanbul lounge access.' },
      { id: 'tl-mr-4', date: '2026-01-15', type: 'purchase', title: 'Purchase: MAD → AYT', description: 'Round-trip booking Madrid–Antalya. Booking confirmation in Spanish, pre-trip content in Turkish. Inconsistent language handling noted.' },
      { id: 'tl-mr-5', date: '2025-06-20', type: 'signup', title: 'Account Created', description: 'Signed up for Miles&Smiles program. Profile set to Spanish but received first email in Turkish — language detection issue.' },
    ],
    emails: [
      { id: 'em-mr-1', subject: 'Ofertas Especiales: Vuela a Estambul desde €199', date: '2026-04-13', category: 'promo', opened: true, clicked: true, hasHtml: true },
      { id: 'em-mr-2', subject: 'İstanbul\'dan Dünyaya — Yeni Rotalar', date: '2026-03-20', category: 'promo', opened: true, clicked: false, hasHtml: true },
      { id: 'em-mr-3', subject: 'Tu Estado Miles&Smiles — Silver Alcanzado', date: '2026-03-01', category: 'loyalty', opened: true, clicked: true, hasHtml: true },
      { id: 'em-mr-4', subject: 'Nueva Ruta: Madrid → Bakú Desde Junio', date: '2026-02-10', category: 'promo', opened: false, clicked: false, hasHtml: true },
    ],
    notes: [
      { id: 'nt-mr-1', text: 'Turkish Airlines dual-market strategy is inconsistent. Profile language is Spanish but some emails arrive in Turkish. No clear language preference logic.', date: '2026-04-14', pinned: true, tags: ['language', 'bug'] },
      { id: 'nt-mr-2', text: 'Multi-city bookings trigger interesting email sequences — stopover guides are unique to Turkish Airlines. Good content strategy for hub positioning.', date: '2026-03-31', pinned: false, tags: ['multi-city', 'content'] },
      { id: 'nt-mr-3', text: 'Silver tier upgrade email was well-designed but only in Spanish. BA and Qatar send tier emails in both languages for multi-market members.', date: '2026-03-02', pinned: false, tags: ['loyalty', 'comparison'] },
    ],
  },
  {
    id: 'spy-005',
    name: 'Alex Wong',
    initials: 'AW',
    avatarGradient: ['#3b82f6', '#2563eb'],
    competitor: 'british',
    competitorName: 'British Airways',
    market: 'Hong Kong, HK',
    language: 'en',
    program: 'Executive Club',
    email: 'alex.wong.spy@proton.me',
    engagementType: 'loyalty',
    status: 'active',
    tier: 'Platinum',
    tierColor: '#e5e7eb',
    createdAt: '2025-03-10',
    tags: ['Executive Club', 'High Spender'],
    stats: {
      emailsReceived: 312,
      purchases: 15,
      lastActivity: '2026-04-14',
      avgEmailsPerWeek: 5.5,
      daysActive: 400,
      loyaltyPoints: 284000,
    },
    emailBreakdown: { promo: 65, loyalty: 98, transactional: 72, newsletter: 40, retargeting: 22, other: 15 },
    recentActivity: 'Received Platinum exclusive lounge invitation',
    timeline: [
      { id: 'tl-aw-1', date: '2026-04-14', type: 'email', title: 'Platinum Exclusive: Concorde Lounge Event', description: 'Invitation to exclusive Concorde Room event at LHR T5. RSVP link with personalized greeting. Premium design with gold accents.' },
      { id: 'tl-aw-2', date: '2026-04-01', type: 'tier-change', title: 'Tier Renewed: Platinum', description: 'Platinum status renewed for another year. Email included tier point summary, upcoming benefits, and companion voucher reminder.' },
      { id: 'tl-aw-3', date: '2026-03-20', type: 'purchase', title: 'Purchase: HKG → LHR (Club World)', description: 'Business class round-trip HKG–LHR. Booking confirmation with lounge access details, chauffeur service, and meal pre-selection.' },
      { id: 'tl-aw-4', date: '2026-02-28', type: 'purchase', title: 'Purchase: HKG → JFK (First)', description: 'First class booking HKG–JFK via LHR. Premium confirmation email with concierge service details and Heathrow VIP transfer.' },
      { id: 'tl-aw-5', date: '2025-12-15', type: 'tier-change', title: 'Tier Upgrade to Platinum', description: 'Upgraded from Gold to Platinum after exceeding 1,500 tier points. Personalized video email from Executive Club team.' },
    ],
    emails: [
      { id: 'em-aw-1', subject: 'Exclusive Invitation: Concorde Room Private Event', date: '2026-04-14', category: 'loyalty', opened: true, clicked: true, hasHtml: true },
      { id: 'em-aw-2', subject: 'Your Avios Statement — 284,000 Points Available', date: '2026-04-01', category: 'loyalty', opened: true, clicked: false, hasHtml: true },
      { id: 'em-aw-3', subject: 'Upgrade Offer: Club World to First — HKG to LHR', date: '2026-03-15', category: 'promo', opened: true, clicked: true, hasHtml: true },
      { id: 'em-aw-4', subject: 'Your Companion Voucher Is Ready to Use', date: '2026-03-01', category: 'loyalty', opened: true, clicked: true, hasHtml: true },
    ],
    notes: [
      { id: 'nt-aw-1', text: 'BA Platinum treatment is industry-leading. Personalized video email for tier upgrade, exclusive event invitations, companion voucher. Very high-touch for top tier.', date: '2026-04-14', pinned: true, tags: ['loyalty', 'best-practice'] },
      { id: 'nt-aw-2', text: 'First class booking confirmation includes concierge details and VIP transfer — no other competitor includes this level of post-booking service info in transactional emails.', date: '2026-03-01', pinned: false, tags: ['transactional', 'premium'] },
      { id: 'nt-aw-3', text: 'Upgrade offers are well-timed — sent 5 days before departure. Pricing is transparent with Avios + cash options shown clearly.', date: '2026-03-16', pinned: false, tags: ['upsell', 'timing'] },
    ],
  },
  {
    id: 'spy-006',
    name: 'Fatima Al-Khalili',
    initials: 'FK',
    ...
    language: 'ar',
    program: 'Privilege Club',
    email: 'fatima.alkhalili.spy@proton.me',
    engagementType: 'new-signup',
    status: 'active',
    tier: null,
    tierColor: null,
    createdAt: '2026-03-31',
    tags: ['Welcome Flow', 'Arabic Comms'],
    stats: {
      emailsReceived: 12,
      purchases: 0,
      lastActivity: '2026-04-13',
      avgEmailsPerWeek: 6.0,
      daysActive: 14,
      loyaltyPoints: 0,
    },
    emailBreakdown: { promo: 3, loyalty: 1, transactional: 1, newsletter: 2, retargeting: 0, other: 5 },
    recentActivity: 'Received first promotional email after welcome series',
    timeline: [
      { id: 'tl-fk-1', date: '2026-04-13', type: 'email', title: 'First Promo Email', description: 'First promotional email post-welcome series. Eid travel deals for DOH–CAI and DOH–AMM. Arabic language with RTL layout perfectly rendered.' },
      { id: 'tl-fk-2', date: '2026-04-05', type: 'email', title: 'Profile Completion Reminder', description: 'Email nudging profile completion — add travel preferences, passport details, and meal preferences. Incentive: 500 bonus Qmiles.' },
      { id: 'tl-fk-3', date: '2026-03-31', type: 'signup', title: 'Account Created', description: 'Signed up for Privilege Club from Doha. Arabic language auto-detected. Welcome email sent immediately with app download CTA and Qmiles earning guide.' },
    ],
    emails: [
      { id: 'em-fk-1', subject: 'مرحباً بك في نادي الامتياز — ابدأ رحلتك', date: '2026-03-31', category: 'transactional', opened: true, clicked: true, hasHtml: true },
      { id: 'em-fk-2', subject: 'أكمل ملفك الشخصي واحصل على 500 كيو مايلز', date: '2026-04-05', category: 'loyalty', opened: true, clicked: false, hasHtml: true },
      { id: 'em-fk-3', subject: 'عروض العيد: سافر من الدوحة بأسعار مميزة', date: '2026-04-13', category: 'promo', opened: true, clicked: true, hasHtml: true },
    ],
    notes: [
      { id: 'nt-fk-1', text: 'Qatar Arabic onboarding is excellent. RTL layout renders perfectly, cultural references are appropriate (Eid, Ramadan). Language auto-detection worked flawlessly.', date: '2026-04-14', pinned: true, tags: ['arabic', 'onboarding'] },
      { id: 'nt-fk-2', text: 'Profile completion nudge with 500 Qmiles incentive is smart. Sent 5 days after signup — good timing. Emirates should consider similar approach.', date: '2026-04-06', pinned: false, tags: ['incentive', 'profile'] },
    ],
  },
  {
    id: 'spy-007',
    name: 'Hans Weber',
    initials: 'HW',
    avatarGradient: ['#64748b', '#475569'],
    competitor: 'etihad',
    competitorName: 'Etihad Airways',
    market: 'Frankfurt, DE',
    language: 'de',
    program: 'Etihad Guest',
    email: 'hans.weber.spy@proton.me',
    engagementType: 'loyalty',
    status: 'active',
    tier: 'Guest',
    tierColor: '#94a3b8',
    createdAt: '2025-10-18',
    tags: ['Sustainability', 'EU Market'],
    stats: {
      emailsReceived: 95,
      purchases: 2,
      lastActivity: '2026-04-10',
      avgEmailsPerWeek: 3.7,
      daysActive: 180,
      loyaltyPoints: 12300,
    },
    emailBreakdown: { promo: 25, loyalty: 15, transactional: 10, newsletter: 28, retargeting: 8, other: 9 },
    recentActivity: 'Opened Greenliner sustainability campaign email',
    timeline: [
      { id: 'tl-hw-1', date: '2026-04-10', type: 'email', title: 'Greenliner Campaign Email', description: 'Sustainability-focused email highlighting Etihad Greenliner program. Carbon offset calculator embedded in email. German language with EU sustainability certifications.' },
      { id: 'tl-hw-2', date: '2026-03-25', type: 'email-cluster', title: 'Sustainability Campaign Cluster', description: 'Received 4 emails over 2 weeks — all sustainability-themed. SAF investments, carbon offset, eco-routes, and annual sustainability report. Clearly a strategic push.' },
      { id: 'tl-hw-3', date: '2026-02-20', type: 'purchase', title: 'Purchase: FRA → AUH', description: 'Economy class round-trip FRA–AUH. Booking confirmation included voluntary carbon offset option prominently displayed.' },
      { id: 'tl-hw-4', date: '2025-12-10', type: 'purchase', title: 'Purchase: FRA → AUH', description: 'First purchase — Economy FRA–AUH for holiday travel. Standard booking confirmation with no sustainability messaging at this point.' },
      { id: 'tl-hw-5', date: '2025-10-18', type: 'signup', title: 'Account Created', description: 'Signed up for Etihad Guest. Welcome email in English despite German market — language preference not applied until manual update.' },
    ],
    emails: [
      { id: 'em-hw-1', subject: 'Etihad Greenliner: Unsere Nachhaltigkeitsvision', date: '2026-04-10', category: 'newsletter', opened: true, clicked: true, hasHtml: true },
      { id: 'em-hw-2', subject: 'Willkommen bei Etihad Guest — Ihre Vorteile', date: '2025-10-18', category: 'loyalty', opened: true, clicked: false, hasHtml: true },
      { id: 'em-hw-3', subject: 'Etihad Nachhaltigkeitsbericht 2025 — Unsere Fortschritte', date: '2026-03-28', category: 'newsletter', opened: true, clicked: true, hasHtml: true },
    ],
    notes: [
      { id: 'nt-hw-1', text: 'Etihad Greenliner campaign is strong — embedded carbon calculator in email is innovative. EU market clearly gets sustainability-heavy messaging. Emirates could learn from this approach.', date: '2026-04-11', pinned: true, tags: ['sustainability', 'innovation'] },
      { id: 'nt-hw-2', text: 'Language issue on signup — received English welcome email despite Frankfurt market. Fixed after manual language preference update. Same issue as Turkish Airlines with Maria.', date: '2025-10-20', pinned: false, tags: ['language', 'bug'] },
    ],
  },
  {
    id: 'spy-008',
    name: 'Priya Sharma',
    initials: 'PS',
    avatarGradient: ['#f97316', '#fb923c'],
    competitor: 'singapore',
    competitorName: 'Singapore Airlines',
    market: 'Mumbai, IN',
    language: 'en',
    program: 'KrisFlyer',
    email: 'priya.sharma.spy@proton.me',
    engagementType: 'cart-abandon',
    status: 'active',
    tier: null,
    tierColor: null,
    createdAt: '2026-02-14',
    tags: ['Price-Sensitive', 'Indian Market'],
    stats: {
      emailsReceived: 45,
      purchases: 0,
      lastActivity: '2026-04-12',
      avgEmailsPerWeek: 5.2,
      daysActive: 60,
      loyaltyPoints: 0,
    },
    emailBreakdown: { promo: 15, loyalty: 2, transactional: 1, newsletter: 8, retargeting: 16, other: 3 },
    recentActivity: 'Received flash sale email for BOM → SIN',
    timeline: [
      { id: 'tl-ps-1', date: '2026-04-12', type: 'email', title: 'Flash Sale: BOM → SIN', description: 'Flash sale email with 48-hour countdown timer. BOM–SIN from ₹18,999. Price shown in INR with EMI option highlighted — India-specific pricing strategy.' },
      { id: 'tl-ps-2', date: '2026-04-02', type: 'cart-abandon', title: 'Cart Abandon: BOM → SIN (2nd)', description: 'Second cart abandon for BOM–SIN route. Retargeting email included price comparison chart showing fare history. More sophisticated than first abandon email.' },
      { id: 'tl-ps-3', date: '2026-03-15', type: 'email', title: 'Price Drop Alert: BOM → SIN', description: 'Price drop notification for previously searched BOM–SIN route. Email shows old price vs new price with savings highlighted. Triggered by fare change, not abandon.' },
      { id: 'tl-ps-4', date: '2026-03-01', type: 'cart-abandon', title: 'Cart Abandon: BOM → SIN (1st)', description: 'First cart abandon for BOM–SIN. Basic retargeting email sent after 3 hours. No discount, just booking reminder with destination content.' },
      { id: 'tl-ps-5', date: '2026-02-14', type: 'signup', title: 'Account Created', description: 'Signed up for KrisFlyer. Welcome email with India-specific content — INR pricing, Mumbai departure routes, and EMI payment options.' },
    ],
    emails: [
      { id: 'em-ps-1', subject: 'Your Singapore Trip Awaits — Complete Your Booking', date: '2026-04-02', category: 'retargeting', opened: true, clicked: false, hasHtml: true },
      { id: 'em-ps-2', subject: 'Price Drop Alert: Mumbai → Singapore Now ₹18,999', date: '2026-03-15', category: 'retargeting', opened: true, clicked: true, hasHtml: true },
      { id: 'em-ps-3', subject: 'Flash Sale: 48 Hours Only — Fly to Singapore from ₹18,999', date: '2026-04-12', category: 'promo', opened: true, clicked: true, hasHtml: true },
    ],
    notes: [
      { id: 'nt-ps-1', text: 'SIA India market strategy is price-first. EMI options, INR pricing, fare history charts in retargeting. Very different from their premium positioning in other markets.', date: '2026-04-13', pinned: true, tags: ['pricing', 'india-market'] },
      { id: 'nt-ps-2', text: 'Second cart abandon email was more sophisticated — included fare history chart. SIA is using progressive retargeting (simple first, data-rich second). Smart escalation.', date: '2026-04-03', pinned: false, tags: ['retargeting', 'progressive'] },
    ],
  },
];
